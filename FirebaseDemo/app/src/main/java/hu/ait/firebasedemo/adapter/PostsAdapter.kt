package hu.ait.firebasedemo.adapter
...
import hu.ait.firebasedemo.CreatePostActivity
import hu.ait.firebasedemo.ScrollingActivity
import hu.ait.firebasedemo.data.Post
import hu.ait.firebasedemo.databinding.PostRowBinding
...
class PostsAdapter : RecyclerView.Adapter<PostsAdapter.ViewHolder>  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = PostRowBinding.inflate((context as ScrollingActivity).layoutInflater, parent, false)
