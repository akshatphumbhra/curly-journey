...
import hu.ait.firebasedemo.adapter.PostsAdapter
import hu.ait.firebasedemo.data.Post
import hu.ait.firebasedemo.databinding.ActivityScrollingBinding
...
class ScrollingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = PostsAdapter(this, FirebaseAuth.getInstance().currentUser!!.uid)
